...
{
    public class CustomInfoCreateValidator : AbstractValidator<CustomInfoCreateDto>
    {
        public CustomInfoCreateValidator()
        {
            RuleFor(x => x.Tittle)
            ...
            RuleFor(x => x.Image).NotEmpty().WithMessage("You can't send empty value");
        }
    }
}
